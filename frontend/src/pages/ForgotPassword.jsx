    ...
    <div className="auth-page">
      <div className="auth-illustration-side">
        ...
        <div className="illustration-content">
          ...
          <h2 className="illustration-title">Reset Your Password</h2>
          <p className="illustration-text">We'll help you get back into your account.</p>
        </div>
      </div>
        ...
        <div className="auth-card">
          {step === 1 ? (
            ...
            <>
              ...
              <p className="login-subtitle">Enter the OTP sent to {email}</p>
          ...
          <p className="switch-auth-text">
            Remember your password? <Link to="/" className="link-text">Login</Link>
          </p>
        </div>
      </div>
    </div>
